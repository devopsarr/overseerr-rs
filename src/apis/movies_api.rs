...
/// struct for typed errors of method [`get_movie_by_movie_id`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetMovieByMovieIdError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_movie_ratings`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetMovieRatingsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`get_movie_ratingscombined`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetMovieRatingscombinedError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`get_movie_similar`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetMovieSimilarError {
    UnknownValue(serde_json::Value),
}
...
pub async fn get_movie_by_movie_id(configuration: &configuration::Configuration, movie_id: f64, language: Option<&str>) -> Result<models::MovieDetails, Error<GetMovieByMovieIdError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetMovieByMovieIdError> = serde_json::from_str(&content).ok();
...
pub async fn get_movie_ratings(configuration: &configuration::Configuration, movie_id: f64) -> Result<models::GetMovieRatings2XxResponse, Error<GetMovieRatingsError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetMovieRatings2XxResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetMovieRatings2XxResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetMovieRatingsError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_movie_ratingscombined(configuration: &configuration::Configuration, movie_id: f64) -> Result<models::GetMovieRatingscombined2XxResponse, Error<GetMovieRatingscombinedError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::GetMovieRatingscombined2XxResponse`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::GetMovieRatingscombined2XxResponse`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetMovieRatingscombinedError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn get_movie_similar(configuration: &configuration::Configuration, movie_id: f64, page: Option<f64>, language: Option<&str>) -> Result<models::GetDiscoverMovies2XxResponse, Error<GetMovieSimilarError>> {
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetMovieSimilarError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
