...
impl RadarrSettings {
    pub fn new(name: String, hostname: String, port: f64, api_key: String, use_ssl: bool, active_profile_id: f64, active_profile_name: String, active_directory: String, is4k: bool, minimum_availability: String, is_default: bool) -> RadarrSettings {
        RadarrSettings {
            id: None,
            name,
            hostname,
