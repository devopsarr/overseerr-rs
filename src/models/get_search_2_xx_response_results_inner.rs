...
pub struct GetSearch2XxResponseResultsInner {
    #[serde(rename = "id")]
    pub id: f64,
...
impl GetSearch2XxResponseResultsInner {
    pub fn new(id: f64, media_type: String, title: String) -> GetSearch2XxResponseResultsInner {
